...
function redBalloon() {
  var red = createSprite(0,Math.round(random(60, 200)), 10, 10);
...
function blueBalloon() {
  var blue = createSprite(0,Math.round(random(100, 380)), 10, 10);
...
function greenBalloon() {
  var green = createSprite(0,Math.round(random(140, 430)), 10, 10);
...
function pinkBalloon() {
  var pink = createSprite(0,Math.round(random(180, 480)), 10, 10);
